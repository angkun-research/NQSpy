...
E_exact = -2.541281 #eigvals[0] # Ls = [11,21,31,41,51] E_exact = [-2.42988202, -2.519684,-2.541281,-2.5496381,-2.553721]
...
for step in trange(epochs, desc="VMC Sampling"):
    ...
    #             max_grad = param_max
    # print(f"learning rate: {lr:.4e}, Maximum gradient: {max_grad:.4e}")
...
csv_path = f"data/energy_error_exact_L{L}_t2{t2}_hidden{hidden_dim}_kernel{kernel_size}_sam{totalsam}.csv"
